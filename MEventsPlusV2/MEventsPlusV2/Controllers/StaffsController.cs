...
namespace MEventsPlusV2.Controllers
{
    public class StaffsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,FName,LName,Email,Telno,Jobrole")] Staff staff)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,FName,LName,Email,Telno,Jobrole")] Staff staff)
        {
            if (id != staff.ID)
            {
                return NotFound();
